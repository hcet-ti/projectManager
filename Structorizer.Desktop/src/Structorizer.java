...
public class Structorizer
{
	...
	public static void main(String args[])
	{
		...
		// custom code start
		if (exportPNG == true && exportTo != null && exportFrom != null)
		{
			var dim = mainform.getMinimumSize();
			dim.setSize(0, 0);
			mainform.setMinimumSize(dim);
			mainform.setSize(0, 0);
			mainform.setResizable(false);
			mainform.diagram.openNsdOrArr(exportFrom);
			mainform.diagram.exportPNG(exportTo);
			System.exit(0);
		}
		// custom code end
