...
Rem Generated by Structorizer 3.32-04 
...
Function adjustSpelling(sentence As String) As String
  ...
  End If
  Dim arraya8345b26() As String = {" i ", " i\'"}
  For Each word In arraya8345b26
...
Function normalizeInput(sentence As String) As String
  ...
  Dim arrayeb858363() As FIXME_eb858363 = {'.', ',', ';', '!', '?'}
  For Each symbol In arrayeb858363
