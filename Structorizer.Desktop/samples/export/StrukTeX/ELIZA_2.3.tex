...
\begin{struktogramm}(173,114)[adjustSpelling]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(185,61)[checkGoodBye]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(162,95)[checkRepetition]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(268,102)[conjugateStrings]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(223,99)[findKeyword]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(242,69)[normalizeInput]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(185,31)[setupGoodByePhrases]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(125,150)[setupKeywords]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(116,90)[setupReflexions]
  \assign{%
    \begin{declaration}[Result type:]
      \description{array of array[0..1] of string}{}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(153,549)[setupReplies]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(284,347)[ELIZA]
  \assign{%
    \begin{declaration}[Requires:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(152,39)[History]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(142,28)[KeyMapEntry]
  \assign{%
    \begin{declaration}[type:]
