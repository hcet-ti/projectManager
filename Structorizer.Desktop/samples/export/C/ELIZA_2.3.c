...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arraya8345b26[2] = {" i ", " i\'"};
		int indexa8345b26;
		for (indexa8345b26 = 0; indexa8345b26 < 2; indexa8345b26++) {
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count98b6f191 = ???;
		int index98b6f191;
		for (index98b6f191 = 0; index98b6f191 < count98b6f191; index98b6f191++) {
			char* pair[] = phrases[index98b6f191];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countf1e81577 = ???;
		int indexf1e81577;
		for (indexf1e81577 = 0; indexf1e81577 < countf1e81577; indexf1e81577++) {
			char* pair[] = flexions[indexf1e81577];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arrayeb858363[5] = {'.', ',', ';', '!', '?'};
		int indexeb858363;
		for (indexeb858363 = 0; indexeb858363 < 5; indexeb858363++) {
			char symbol = arrayeb858363[indexeb858363];
