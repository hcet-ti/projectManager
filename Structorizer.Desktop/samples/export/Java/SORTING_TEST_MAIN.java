...
public class SORTING_TEST_MAIN {
	...
	public static void main(String[] args) {
		...
		class Worker1b4c8697_0 implements Callable<Object[]> {
			private int[] values1;
		...
		class Worker1b4c8697_1 implements Callable<Object[]> {
			private int[] values2;
		...
		class Worker1b4c8697_2 implements Callable<Object[]> {
			private int[] values3;
		...
		try {
			...
			// ----------------- START THREAD 0 ----------------- 
			Future<Object[]> future1b4c8697_0 = pool.submit( new Worker1b4c8697_0(values1) );
		
			// ----------------- START THREAD 1 ----------------- 
			Future<Object[]> future1b4c8697_1 = pool.submit( new Worker1b4c8697_1(values2, elementCount) );
		
			// ----------------- START THREAD 2 ----------------- 
			Future<Object[]> future1b4c8697_2 = pool.submit( new Worker1b4c8697_2(values3) );
		
			// ----------------- AWAIT THREAD 0 ----------------- 
			future1b4c8697_0.get();
			// ----------------- AWAIT THREAD 1 ----------------- 
			future1b4c8697_1.get();
			// ----------------- AWAIT THREAD 2 ----------------- 
			future1b4c8697_2.get();
			pool.shutdown();
		}
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		// =========== START PARALLEL WORKER DEFINITIONS ============ 
		class Worker1151c3b_0 implements Callable<Object[]> {
			private ??? values;
			private ??? start;
			private ??? p;
		...
		class Worker1151c3b_1 implements Callable<Object[]> {
			private ??? values;
			private ??? p;
			private ??? stop;
		...
		if (stop >= start + 2) {
			...
			try {
				...
				// ----------------- START THREAD 0 ----------------- 
				Future<Object[]> future1151c3b_0 = pool.submit( new Worker1151c3b_0(values, start, p) );
			
				// ----------------- START THREAD 1 ----------------- 
				Future<Object[]> future1151c3b_1 = pool.submit( new Worker1151c3b_1(values, p, stop) );
