...
var
  indexeb858363: 1..5;
  arrayeb858363: array [1..5] of string;
  indexa8345b26: 1..2;
  arraya8345b26: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arraya8345b26[1] := ' i ';
  arraya8345b26[2] := ' i\''';
  for indexa8345b26 := 1 to 2 do
  begin
    word := arraya8345b26[indexa8345b26];
...
begin
  ...
  arrayeb858363[4] := '!';
  arrayeb858363[5] := '?';
  for indexeb858363 := 1 to 5 do
  begin
    symbol := arrayeb858363[indexeb858363];
