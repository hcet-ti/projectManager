...
var
  index1789d343: 1..5;
  array1789d343: array [1..5] of string;
  index2a44329b: 1..2;
  array2a44329b: array [1..2] of string;
  indexff31bf2c: 1..2;
  arrayff31bf2c: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayff31bf2c[1] := ' i ';
  arrayff31bf2c[2] := ' i\''';
  for indexff31bf2c := 1 to 2 do
  begin
    word := arrayff31bf2c[indexff31bf2c];
...
begin
  ...
  array2a44329b[1] := ' ';
  array2a44329b[2] := '|';
  for index2a44329b := 1 to 2 do
  begin
    str := array2a44329b[index2a44329b];
...
begin
  ...
  array1789d343[4] := '!';
  array1789d343[5] := '?';
  for index1789d343 := 1 to 5 do
  begin
    symbol := array1789d343[index1789d343];
