...
function findKeyword() {
 ...
 declare -a -g result7d697214=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result9a7acf9=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result493e6203=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a reflexions[3]=(" yours " " mine ")
 declare -a reflexions[4]=(" yourself " " myself ")
 declare -a reflexions[5]=(" your " " my ")
 declare -a reflexions[6]=(" i\'ve " " you\'ve ")
 declare -a reflexions[7]=(" i\'m " " you\'re ")
 # We must not replace "you" by "me", not in particular after "I" had been replaced by "you". 
 declare -a reflexions[8]=(" me " " |you ")
 declare -a -g result4df91ea6=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result5422dd93=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result5422dd93[@]}")
setupReflexions
declare -ar reflexions=("${result4df91ea6[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result9a7acf9[@]}")
setupKeywords
declare -ar keyMap=("${result493e6203[@]}")
