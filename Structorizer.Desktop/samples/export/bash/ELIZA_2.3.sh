...
function findKeyword() {
 ...
 declare -a -g resultb2d653bc=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result34c960ac=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultdd5c1037=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result77f65661=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultc874dffd=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${resultc874dffd[@]}")
setupReflexions
declare -ar reflexions=("${result77f65661[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result34c960ac[@]}")
setupKeywords
declare -ar keyMap=("${resultdd5c1037[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resultb2d653bc[@]}")
   keyIndex=${findInfo[0]}
