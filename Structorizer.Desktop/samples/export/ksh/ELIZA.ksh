...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7d697214 "${result[@]}"; export result7d697214
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result9a7acf9 "${phrases[@]}"; export result9a7acf9
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result493e6203 "${keywords[@]}"; export result493e6203
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result4df91ea6 "${reflexions[@]}"; export result4df91ea6
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result5422dd93 "${setupReplies[@]}"; export result5422dd93
}
...
setupReplies
set -A replies "${result5422dd93[@]}"
setupReflexions
set -A reflexions "${result4df91ea6[@]}"
setupGoodByePhrases
set -A byePhrases "${result9a7acf9[@]}"
setupKeywords
set -A keyMap "${result493e6203[@]}"
