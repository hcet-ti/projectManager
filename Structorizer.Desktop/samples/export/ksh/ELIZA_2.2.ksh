...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultb776e651 "${result[@]}"; export resultb776e651
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result96f94904 "${phrases[@]}"; export result96f94904
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result10e8036f "${keywords[@]}"; export result10e8036f
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result69977285 "${reflexions[@]}"; export result69977285
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result567e7275 "${setupReplies[@]}"; export result567e7275
}
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${result567e7275[@]}"
setupReflexions
set -A reflexions "${result69977285[@]}"
setupGoodByePhrases
set -A byePhrases "${result96f94904[@]}"
setupKeywords
set -A keyMap "${result10e8036f[@]}"
