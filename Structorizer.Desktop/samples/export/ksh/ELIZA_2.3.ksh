...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultb2d653bc "${result[@]}"; export resultb2d653bc
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result34c960ac "${phrases[@]}"; export result34c960ac
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultdd5c1037 "${keywords[@]}"; export resultdd5c1037
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result77f65661 "${reflexions[@]}"; export result77f65661
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc874dffd "${setupReplies[@]}"; export resultc874dffd
}
...
setupReplies
set -A replies "${resultc874dffd[@]}"
setupReflexions
set -A reflexions "${result77f65661[@]}"
setupGoodByePhrases
set -A byePhrases "${result34c960ac[@]}"
setupKeywords
set -A keyMap "${resultdd5c1037[@]}"
