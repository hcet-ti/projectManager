...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr1151c3b_0 = Thread(target=quickSort, args=(values,start,p))
        thr1151c3b_0.start()
        
        thr1151c3b_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr1151c3b_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr1b4c8697_0 = Thread(target=bubbleSort, args=(values1,))
thr1b4c8697_0.start()

thr1b4c8697_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr1b4c8697_1.start()

thr1b4c8697_2 = Thread(target=heapSort, args=(values3,))
thr1b4c8697_2.start()
