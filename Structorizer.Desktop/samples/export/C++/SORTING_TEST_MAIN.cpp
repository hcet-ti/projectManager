...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc1151c3b_0 thrfunc1151c3b_0;
			std::thread thr1151c3b_0(thrfunc1151c3b_0, values, start, p);
		
			ThrFunc1151c3b_1 thrfunc1151c3b_1;
			std::thread thr1151c3b_1(thrfunc1151c3b_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc1b4c8697_0 thrfunc1b4c8697_0;
		std::thread thr1b4c8697_0(thrfunc1b4c8697_0, values1);
	
		ThrFunc1b4c8697_1 thrfunc1b4c8697_1;
		std::thread thr1b4c8697_1(thrfunc1b4c8697_1, values2, elementCount);
	
		ThrFunc1b4c8697_2 thrfunc1b4c8697_2;
		std::thread thr1b4c8697_2(thrfunc1b4c8697_2, values3);
