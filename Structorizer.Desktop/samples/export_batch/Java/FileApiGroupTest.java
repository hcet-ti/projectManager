...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex6e970d39) {
			String error = ex6e970d39.getMessage()
			throw ex6e970d39;
		}
		finally {
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex5df7a0df) {
				String failure = ex5df7a0df.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex8c64feb0) {
				String failure = ex8c64feb0.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
