...
public class ELIZA {
	...
	public static void main(String[] args) {
		...
		System.out.println("* Version: 2.4 (2022-01-11)");
	...
	private static String[][] setupReflexions() {
		...
		reflexions[3] = new String[]{" yours ", " mine "};
		reflexions[4] = new String[]{" yourself ", " myself "};
		reflexions[5] = new String[]{" your ", " my "};
		reflexions[6] = new String[]{" i\'ve ", " you\'ve "};
		reflexions[7] = new String[]{" i\'m ", " you\'re "};
		// We must not replace "you" by "me", not in particular after "I" had been replaced by "you". 
		reflexions[8] = new String[]{" me ", " |you "};
		return reflexions;
	}
