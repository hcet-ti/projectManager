...
public class SORTING_TEST_MAIN {
	...
	public static void main(String[] args) {
		...
		class Workereb4c7801_0 implements Callable<Object[]> {
			private int[] values1;
			public Workereb4c7801_0(int[] values1) {
		...
		class Workereb4c7801_1 implements Callable<Object[]> {
			private int[] values2;
			private ??? elementCount;
			public Workereb4c7801_1(int[] values2, ??? elementCount) {
		...
		class Workereb4c7801_2 implements Callable<Object[]> {
			private int[] values3;
			public Workereb4c7801_2(int[] values3) {
		...
		try {
			...
			// ----------------- START THREAD 0 ----------------- 
			Future<Object[]> futureeb4c7801_0 = pool.submit( new Workereb4c7801_0(values1) );
		
			// ----------------- START THREAD 1 ----------------- 
			Future<Object[]> futureeb4c7801_1 = pool.submit( new Workereb4c7801_1(values2, elementCount) );
		
			// ----------------- START THREAD 2 ----------------- 
			Future<Object[]> futureeb4c7801_2 = pool.submit( new Workereb4c7801_2(values3) );
		
			// ----------------- AWAIT THREAD 0 ----------------- 
			futureeb4c7801_0.get();
			// ----------------- AWAIT THREAD 1 ----------------- 
			futureeb4c7801_1.get();
			// ----------------- AWAIT THREAD 2 ----------------- 
			futureeb4c7801_2.get();
			pool.shutdown();
		}
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		// =========== START PARALLEL WORKER DEFINITIONS ============ 
		class Workerddace7b1_0 implements Callable<Object[]> {
			private ??? values;
			private ??? start;
			private ??? p;
			public Workerddace7b1_0(??? values, ??? start, ??? p) {
				this.values = values;
				this.start = start;
				this.p = p;
			}
		...
		class Workerddace7b1_1 implements Callable<Object[]> {
			private ??? values;
			private ??? p;
			private ??? stop;
			public Workerddace7b1_1(??? values, ??? p, ??? stop) {
				this.values = values;
				this.p = p;
				this.stop = stop;
			}
		...
		if (stop >= start + 2) {
			...
			try {
				...
				// ----------------- START THREAD 0 ----------------- 
				Future<Object[]> futureddace7b1_0 = pool.submit( new Workerddace7b1_0(values, start, p) );
			
				// ----------------- START THREAD 1 ----------------- 
				Future<Object[]> futureddace7b1_1 = pool.submit( new Workerddace7b1_1(values, p, stop) );
			
				// ----------------- AWAIT THREAD 0 ----------------- 
				futureddace7b1_0.get();
				// ----------------- AWAIT THREAD 1 ----------------- 
				futureddace7b1_1.get();
				pool.shutdown();
			}
			catch (Exception ex) { System.err.println(ex.getMessage()); ex.printStackTrace(); }
			// ========================================================== 
