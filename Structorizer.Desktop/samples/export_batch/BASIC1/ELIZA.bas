...
Rem Generated by Structorizer 3.32-11 
...
Function adjustSpelling(sentence As String) As String
  ...
  End If
  Dim array806f4dc9() As String = {" i ", " i\'"}
  For Each word In array806f4dc9
...
Function conjugateStrings(sentence As String, key As String, keyPos As integer, flexions As String(50,0 To 1)) As String
  ...
  Dim arrayca78ff1e() As String = {"  ", "|"}
  For Each str In arrayca78ff1e
...
Function normalizeInput(sentence As String) As String
  ...
  Dim array23f0b185() As FIXME_23f0b185 = {'.', ',', ';', '!', '?'}
  For Each symbol In array23f0b185
...
Function setupReflexions() As String(50,0 To 1)
  ...
  Let reflexions(3) = Array(" yours ", " mine ")
  Let reflexions(4) = Array(" yourself ", " myself ")
  Let reflexions(5) = Array(" your ", " my ")
  Let reflexions(6) = Array(" i\'ve ", " you\'ve ")
  Let reflexions(7) = Array(" i\'m ", " you\'re ")
  Rem We must not replace "you" by "me", not in particular after "I" had been replaced by "you". 
  Let reflexions(8) = Array(" me ", " |you ")
  return reflexions
End Function
Rem  
