...
Public Function readNumbers(fileName As String, numbers As integer(50), maxNumbers As integer) As integer
  ...
  Try
    Do While NOT fileEOF(fileNo) AND nNumbers < maxNumbers
      ...
      nNumbers = nNumbers + 1
    Loop
  Catch ex4dde9f9a As Exception
    Dim error As String = ex4dde9f9a.ToString()
    Throw New Exception()
  Finally
    fileClose(fileNo)
  End Try
...
Rem   fileClose(fileNo) 
  ...
  Catch ex43b0c3a1 As Exception
    Dim failure As String = ex43b0c3a1.ToString()
    PRINT failure
    Stop
  End Try
  sum = 0.0
...
If fileNo > 0 Then
  ...
  Catch ex7edeb691 As Exception
    Dim failure As String = ex7edeb691.ToString()
    PRINT failure
  End Try
  If nObtained > 0 Then
    min = numberArray(0)
