...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array10f197ac[2] = {" i ", " i\'"};
		int index10f197ac;
		for (index10f197ac = 0; index10f197ac < 2; index10f197ac++) {
			char* word = array10f197ac[index10f197ac];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int countb03425bb = ???;
		int indexb03425bb;
		for (indexb03425bb = 0; indexb03425bb < countb03425bb; indexb03425bb++) {
			char* pair[] = phrases[indexb03425bb];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countac99d465 = ???;
		int indexac99d465;
		for (indexac99d465 = 0; indexac99d465 < countac99d465; indexac99d465++) {
			char* pair[] = flexions[indexac99d465];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arraya16e0d28[5] = {'.', ',', ';', '!', '?'};
		int indexa16e0d28;
		for (indexa16e0d28 = 0; indexa16e0d28 < 5; indexa16e0d28++) {
			char symbol = arraya16e0d28[indexa16e0d28];
