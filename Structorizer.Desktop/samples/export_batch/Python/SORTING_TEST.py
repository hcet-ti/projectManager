...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr3eabf7d1_0 = Thread(target=quickSort, args=(values,start,p))
        thr3eabf7d1_0.start()
        
        thr3eabf7d1_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr3eabf7d1_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
threb7f4620_0 = Thread(target=bubbleSort, args=(values1,))
threb7f4620_0.start()

threb7f4620_1 = Thread(target=quickSort, args=(values2,0,elementCount))
threb7f4620_1.start()

threb7f4620_2 = Thread(target=heapSort, args=(values3,))
threb7f4620_2.start()
