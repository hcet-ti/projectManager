...
# myhistory <- History{{"", "", "", "", ""}, 0} 
# END (global) code from included diagram "History" 
# BEGIN (global) code from included diagram "KeyMapEntry" 
# Associates a key word in the text with an index in the reply ring array 
# END (global) code from included diagram "KeyMapEntry" 

# Cares for correct letter case among others 
def adjustSpelling(sentence) :
    result = sentence
    position = 1
...
def checkRepetition(history, newInput) :
    hasOccurred = false
    if (length(newInput) > 4):
        histDepth = length(history['histArray'])
        for i in range(0, histDepth-1+1, 1):
...
def conjugateStrings(sentence, key, keyPos, flexions) :
...
def findKeyword(keyMap, sentence) :
...
# in `setupMapping()´ 
def setupReplies() :
    replies = None	# meant to be of type @@String 
...
# Title information 
print("************* ELIZA **************", sep='')
print("* Original design by J. Weizenbaum", sep='')
print("**********************************", sep='')
print("* Adapted for Basic on IBM PC by", sep='')
print("* - Patricia Danielson", sep='')
print("* - Paul Hashfield", sep='')
print("**********************************", sep='')
print("* Adapted for Structorizer by", sep='')
print("* - Kay Gürtzig / FH Erfurt 2016", sep='')
print("* Version: 2.4 (2022-01-11)", sep='')
...
isGone = false
# Starter 
print("Hi! I\'m your new therapist. My name is Eliza. What\'s your problem?", sep='')
while True:
