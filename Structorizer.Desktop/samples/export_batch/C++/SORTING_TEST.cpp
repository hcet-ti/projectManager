...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc80fc9a0b_0 thrfunc80fc9a0b_0;
			std::thread thr80fc9a0b_0(thrfunc80fc9a0b_0, values, start, p);
		
			ThrFunc80fc9a0b_1 thrfunc80fc9a0b_1;
			std::thread thr80fc9a0b_1(thrfunc80fc9a0b_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc5acef1ba_0 thrfunc5acef1ba_0;
		std::thread thr5acef1ba_0(thrfunc5acef1ba_0, values1);
	
		ThrFunc5acef1ba_1 thrfunc5acef1ba_1;
		std::thread thr5acef1ba_1(thrfunc5acef1ba_1, values2, elementCount);
	
		ThrFunc5acef1ba_2 thrfunc5acef1ba_2;
		std::thread thr5acef1ba_2(thrfunc5acef1ba_2, values3);
