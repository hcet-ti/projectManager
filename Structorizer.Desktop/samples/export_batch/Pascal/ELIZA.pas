...
var
  index8a7c27de: 1..5;
  array8a7c27de: array [1..5] of string;
  index20b28c16: 1..2;
  array20b28c16: array [1..2] of string;
  indexbb9c310e: 1..2;
  arraybb9c310e: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arraybb9c310e[1] := ' i ';
  arraybb9c310e[2] := ' i\''';
  for indexbb9c310e := 1 to 2 do
  begin
    word := arraybb9c310e[indexbb9c310e];
...
begin
  ...
  array20b28c16[1] := ' ';
  array20b28c16[2] := '|';
  for index20b28c16 := 1 to 2 do
  begin
    str := array20b28c16[index20b28c16];
...
begin
  ...
  array8a7c27de[4] := '!';
  array8a7c27de[5] := '?';
  for index8a7c27de := 1 to 5 do
  begin
    symbol := array8a7c27de[index8a7c27de];
...
begin
  ...
  reflexions[5, 1] := ' my ';
  { Hint: Automatically decomposed array initialization }
  reflexions[6, 0] := ' i\''ve ', ' you\''ve ';
  { Hint: Automatically decomposed array initialization }
  reflexions[7, 0] := ' i\''m ', ' you\''re ';
...
begin
  ...
  writeln('* Version: 2.4 (2022-01-11)');
