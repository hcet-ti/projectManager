...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result6fcabe07 "${result[@]}"; export result6fcabe07
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result41ef1a72 "${phrases[@]}"; export result41ef1a72
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result3abad6a6 "${keywords[@]}"; export result3abad6a6
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultff14bef7 "${reflexions[@]}"; export resultff14bef7
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result48414a8c "${setupReplies[@]}"; export result48414a8c
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result48414a8c[@]}"
setupReflexions
set -A reflexions "${resultff14bef7[@]}"
setupGoodByePhrases
set -A byePhrases "${result41ef1a72[@]}"
setupKeywords
set -A keyMap "${result3abad6a6[@]}"
