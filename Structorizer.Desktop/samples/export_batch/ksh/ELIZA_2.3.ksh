...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result5731c6fa "${result[@]}"; export result5731c6fa
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result42a14803 "${phrases[@]}"; export result42a14803
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result5ce6b25 "${keywords[@]}"; export result5ce6b25
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7778ade2 "${reflexions[@]}"; export result7778ade2
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7aa58895 "${setupReplies[@]}"; export result7aa58895
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result7aa58895[@]}"
setupReflexions
set -A reflexions "${result7778ade2[@]}"
setupGoodByePhrases
set -A byePhrases "${result42a14803[@]}"
setupKeywords
set -A keyMap "${result5ce6b25[@]}"
