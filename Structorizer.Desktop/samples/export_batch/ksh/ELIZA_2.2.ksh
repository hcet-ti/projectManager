...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultf84d398e "${result[@]}"; export resultf84d398e
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultb2fa1e36 "${phrases[@]}"; export resultb2fa1e36
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result6a6061a2 "${keywords[@]}"; export result6a6061a2
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultcb044a1f "${reflexions[@]}"; export resultcb044a1f
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result2c9f8227 "${setupReplies[@]}"; export result2c9f8227
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${result2c9f8227[@]}"
setupReflexions
set -A reflexions "${resultcb044a1f[@]}"
setupGoodByePhrases
set -A byePhrases "${resultb2fa1e36[@]}"
setupKeywords
set -A keyMap "${result6a6061a2[@]}"
