<?php
// function readNumbers (generated by Structorizer 3.32-01) 
...
function readNumbers($fileName, $numbers, $maxNumbers)
{
	...
	} catch (Exception $eex18331a39) {
		$error = $ex18331a39->getMessage();
		throw new Exception();
	} finally {
...
// 	StructorizerFileAPI::fileClose($fileNo); 
	...
	} catch (Exception $eex92a90a4c) {
		$failure = $ex92a90a4c->getMessage();
		echo failure;
		exit(-7);
	}
	$sum = 0.0;
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eexb341aea4) {
		$failure = $exb341aea4->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
