...
public class readNumbers {
	...
	public static void null() {
		...
		catch(Exception ex56d2d091) {
			string error = ex56d2d091.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception exf689aa78) {
				string failure = exf689aa78.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception exf77999f4) {
				string failure = exf77999f4.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
