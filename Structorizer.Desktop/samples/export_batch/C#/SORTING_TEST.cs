...
public class SORTING_TEST_MAIN {
	...
	class Worker45c11d90_0{
		// TODO: Check and accomplish the member declarations here 
		private int[] values1;
		public Worker45c11d90_0(int[] values1)
		{
	...
	class Worker45c11d90_1{
		// TODO: Check and accomplish the member declarations here 
		private int[] values2;
		private ??? elementCount;
		public Worker45c11d90_1(int[] values2, ??? elementCount)
		{
	...
	class Worker45c11d90_2{
		// TODO: Check and accomplish the member declarations here 
		private int[] values3;
		public Worker45c11d90_2(int[] values3)
		{
	...
	// =========== START PARALLEL WORKER DEFINITIONS ============ 
	class Worker6425998b_0{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? start;
		private ??? p;
		public Worker6425998b_0(??? values, ??? start, ??? p)
		{
			this.values = values;
			this.start = start;
			this.p = p;
	...
	class Worker6425998b_1{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? p;
		private ??? stop;
		public Worker6425998b_1(??? values, ??? p, ??? stop)
		{
			this.values = values;
			this.p = p;
			this.stop = stop;
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker45c11d90_0 worker45c11d90_0 = new Worker45c11d90_0(values1);
			Thread thr45c11d90_0 = new Thread(worker45c11d90_0.DoWork);
			thr45c11d90_0.Start();
		
			Worker45c11d90_1 worker45c11d90_1 = new Worker45c11d90_1(values2, elementCount);
			Thread thr45c11d90_1 = new Thread(worker45c11d90_1.DoWork);
			thr45c11d90_1.Start();
		
			Worker45c11d90_2 worker45c11d90_2 = new Worker45c11d90_2(values3);
			Thread thr45c11d90_2 = new Thread(worker45c11d90_2.DoWork);
			thr45c11d90_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker6425998b_0 worker6425998b_0 = new Worker6425998b_0(values, start, p);
				Thread thr6425998b_0 = new Thread(worker6425998b_0.DoWork);
				thr6425998b_0.Start();
			
				Worker6425998b_1 worker6425998b_1 = new Worker6425998b_1(values, p, stop);
				Thread thr6425998b_1 = new Thread(worker6425998b_1.DoWork);
				thr6425998b_1.Start();
