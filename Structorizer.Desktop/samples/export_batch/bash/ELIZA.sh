...
function findKeyword() {
 ...
 declare -a -g resultf54349b4=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result29ffb8ac=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resulta0d2c8d5=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resultdb804190=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultd7aefd67=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${resultd7aefd67[@]}")
setupReflexions
declare -ar reflexions=("${resultdb804190[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result29ffb8ac[@]}")
setupKeywords
declare -ar keyMap=("${resulta0d2c8d5[@]}")
