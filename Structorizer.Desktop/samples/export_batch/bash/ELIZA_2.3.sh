...
function findKeyword() {
 ...
 declare -a -g result8e369de2=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result61add13a=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result29b58215=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result9179b876=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result2d5a33d=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result2d5a33d[@]}")
setupReflexions
declare -ar reflexions=("${result9179b876[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result61add13a[@]}")
setupKeywords
declare -ar keyMap=("${result29b58215[@]}")
