...
function findKeyword() {
 ...
 declare -a -g result8cd71f77=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result6ce7c3cf=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result23442462=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resulte9b8b76c=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resulte308f6a2=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resulte308f6a2[@]}")
setupReflexions
declare -ar reflexions=("${resulte9b8b76c[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result6ce7c3cf[@]}")
setupKeywords
declare -ar keyMap=("${result23442462[@]}")
