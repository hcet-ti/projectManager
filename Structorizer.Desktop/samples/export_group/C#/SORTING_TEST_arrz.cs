...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker465fbb06_0 worker465fbb06_0 = new Worker465fbb06_0(values1);
			Thread thr465fbb06_0 = new Thread(worker465fbb06_0.DoWork);
			thr465fbb06_0.Start();
		
			Worker465fbb06_1 worker465fbb06_1 = new Worker465fbb06_1(values2, elementCount);
			Thread thr465fbb06_1 = new Thread(worker465fbb06_1.DoWork);
			thr465fbb06_1.Start();
		
			Worker465fbb06_2 worker465fbb06_2 = new Worker465fbb06_2(values3);
			Thread thr465fbb06_2 = new Thread(worker465fbb06_2.DoWork);
			thr465fbb06_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker98a2d384_0 worker98a2d384_0 = new Worker98a2d384_0(values, start, p);
				Thread thr98a2d384_0 = new Thread(worker98a2d384_0.DoWork);
				thr98a2d384_0.Start();
			
				Worker98a2d384_1 worker98a2d384_1 = new Worker98a2d384_1(values, p, stop);
				Thread thr98a2d384_1 = new Thread(worker98a2d384_1.DoWork);
				thr98a2d384_1.Start();
