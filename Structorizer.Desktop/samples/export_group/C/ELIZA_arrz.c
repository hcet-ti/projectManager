...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arrayff31bf2c[2] = {" i ", " i\'"};
		int indexff31bf2c;
		for (indexff31bf2c = 0; indexff31bf2c < 2; indexff31bf2c++) {
			char* word = arrayff31bf2c[indexff31bf2c];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count40ee1f74 = ???;
		int index40ee1f74;
		for (index40ee1f74 = 0; index40ee1f74 < count40ee1f74; index40ee1f74++) {
			char* pair[] = phrases[index40ee1f74];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int counte5ae3e4a = ???;
		int indexe5ae3e4a;
		for (indexe5ae3e4a = 0; indexe5ae3e4a < counte5ae3e4a; indexe5ae3e4a++) {
			char* pair[] = flexions[indexe5ae3e4a];
			left = "";
			right = result;
	...
	{
		char* array2a44329b[2] = {"  ", "|"};
		int index2a44329b;
		for (index2a44329b = 0; index2a44329b < 2; index2a44329b++) {
			char* str = array2a44329b[index2a44329b];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array1789d343[5] = {'.', ',', ';', '!', '?'};
		int index1789d343;
		for (index1789d343 = 0; index1789d343 < 5; index1789d343++) {
			char symbol = array1789d343[index1789d343];
