...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arraydbdbf287[2] = {" i ", " i\'"};
		int indexdbdbf287;
		for (indexdbdbf287 = 0; indexdbdbf287 < 2; indexdbdbf287++) {
			char* word = arraydbdbf287[indexdbdbf287];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int countc301598b = ???;
		int indexc301598b;
		for (indexc301598b = 0; indexc301598b < countc301598b; indexc301598b++) {
			char* pair[] = phrases[indexc301598b];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int counta29a4c2f = ???;
		int indexa29a4c2f;
		for (indexa29a4c2f = 0; indexa29a4c2f < counta29a4c2f; indexa29a4c2f++) {
			char* pair[] = flexions[indexa29a4c2f];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arraybd738552[5] = {'.', ',', ';', '!', '?'};
		int indexbd738552;
		for (indexbd738552 = 0; indexbd738552 < 5; indexbd738552++) {
			char symbol = arraybd738552[indexbd738552];
