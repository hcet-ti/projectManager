...
var
  indexbd738552: 1..5;
  arraybd738552: array [1..5] of string;
  indexdbdbf287: 1..2;
  arraydbdbf287: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arraydbdbf287[1] := ' i ';
  arraydbdbf287[2] := ' i\''';
  for indexdbdbf287 := 1 to 2 do
  begin
    word := arraydbdbf287[indexdbdbf287];
...
begin
  ...
  arraybd738552[4] := '!';
  arraybd738552[5] := '?';
  for indexbd738552 := 1 to 5 do
  begin
    symbol := arraybd738552[indexbd738552];
