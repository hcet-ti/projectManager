...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr98a2d384_0 = Thread(target=quickSort, args=(values,start,p))
        thr98a2d384_0.start()
        
        thr98a2d384_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr98a2d384_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr465fbb06_0 = Thread(target=bubbleSort, args=(values1,))
thr465fbb06_0.start()

thr465fbb06_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr465fbb06_1.start()

thr465fbb06_2 = Thread(target=heapSort, args=(values3,))
thr465fbb06_2.start()
