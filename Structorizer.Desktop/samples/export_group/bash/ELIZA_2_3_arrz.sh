...
function setupGoodByePhrases() {
 ...
 declare -a -g resultb20c29f0=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resulta84dc8c1=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resulte20ebf2d=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g result1b844b45=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result5cc3e15a=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${resulte20ebf2d[@]}")
setupReflexions
declare -ar reflexions=("${resulta84dc8c1[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultb20c29f0[@]}")
setupKeywords
declare -ar keyMap=("${result5cc3e15a[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result1b844b45[@]}")
   keyIndex=${findInfo[0]}
