...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc98a2d384_0 thrfunc98a2d384_0;
			std::thread thr98a2d384_0(thrfunc98a2d384_0, values, start, p);
		
			ThrFunc98a2d384_1 thrfunc98a2d384_1;
			std::thread thr98a2d384_1(thrfunc98a2d384_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc465fbb06_0 thrfunc465fbb06_0;
		std::thread thr465fbb06_0(thrfunc465fbb06_0, values1);
	
		ThrFunc465fbb06_1 thrfunc465fbb06_1;
		std::thread thr465fbb06_1(thrfunc465fbb06_1, values2, elementCount);
	
		ThrFunc465fbb06_2 thrfunc465fbb06_2;
		std::thread thr465fbb06_2(thrfunc465fbb06_2, values3);
