...
void pdf_add_table(struct pdf_doc *pdf, struct table table, const float paddingX, const float paddingY, const float x, float *yCursor, const char *header1, const char *header2,  const char *footer1, const char *footer2,  int *pageCounter, const float size, const float width);
char *img_strip_alpha(const char *png, char *dest);
void pdf_add_structogram_by_path(struct pdf_doc *pdf, const char *imgSrcPath, const float x, float *yCursor, const char *header1, const char *header2, const char *footer1, const char *footer2, int *pageCounter, const char *imgDstPath);
void pdf_structorize(struct pdf_doc *pdf, const char *structorizer, const char *output, const char *code, const char *logLocation, const char *structFolder, const float x, float *yCursor, const char *header1, const char *header2, const char *footer1, const char *footer2, int *pageCounter);
